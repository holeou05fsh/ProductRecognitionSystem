...
import sys 
from Data_processing.python_data_into_influxdb import data2influxdb
import pandas as pd
...
def detect_objects():
    ...
    while keep_detecting:
        try:
            ...
            results = model.predict(conf=0.7)
            ...
            for box in boxes:
                ...
                print(confidence, int(confidence) >= 0.7)
                if int(confidence) >= 0.7:  # 仅处理置信度大于等于 0.7 的框
